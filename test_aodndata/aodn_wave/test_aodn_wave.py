...
class TestAodnWaveHandler(unittest.TestCase):
    ...
    def test_dest_path_aodn_wave(self):
        ...
        dest_dir = AodnWaveFileClassifier.dest_path_aodn_wave(testfile)
        ...
        data_type = AodnWaveFileClassifier.get_data_type(testfile)
        self.assertEqual(data_type,'SPECTRA')
