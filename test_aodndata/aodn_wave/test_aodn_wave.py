...
RT_INCOMING_FILE = os.path.join(TEST_ROOT, 'DOT-WA_20220816_ESPERANCE_RT_WAVE-PARAMETERS_END-20220816.nc')
RT_MONTHLY_AGGREGATED_FILE = os.path.join(TEST_ROOT, 'DOT-WA_20220816_ESPERANCE_RT_WAVE-PARAMETERS_monthly.nc')
RT_EXISTING_MONTHLY_FILE = os.path.join(TEST_ROOT, 'DOT-WA_20220814_ESPERANCE_RT_WAVE-PARAMETERS_monthly.nc')
...
class TestAodnWaveHandler(HandlerTestCase):
    ...
    def test_publication_realtime_no_aggregation(self):
        """
        test processing of NRT file : Case#1 incoming file is first file of the month as determined by the presence
        ...
        destination = AodnWaveHandler.dest_path(os.path.basename(RT_MONTHLY_AGGREGATED_FILE))
        self.assertEqual(destination,
                         os.path.join(
                             ...
                             '2022',
                             '08',
                            os.path.basename(RT_MONTHLY_AGGREGATED_FILE)))
    ...
    def test_publication_realtime_with_aggregation(self):
            """
            ...
            existing_file = PipelineFile(RT_EXISTING_MONTHLY_FILE, dest_path=os.path.join(
                'Department_of_Transport-Western_Australia', 'WAVE-BUOYS', 'REALTIME', 'WAVE-PARAMETERS',
                'ESPERANCE', '2022', '08', os.path.basename(RT_EXISTING_MONTHLY_FILE)))
            ...
            destination = AodnWaveHandler.dest_path(os.path.basename(RT_EXISTING_MONTHLY_FILE))
            self.assertEqual(destination,
                             os.path.join(
                                 'Department_of_Transport-Western_Australia',
                                 'WAVE-BUOYS',
                                 ...
                                 '2022',
                                 '08',
                                 os.path.basename(RT_EXISTING_MONTHLY_FILE)))
