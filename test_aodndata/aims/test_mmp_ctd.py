...
class TestMmpCtd(unittest.TestCase):
    ...
    def test_dest_path_mmp_ctd(self):
        ...
        self.assertEqual('AIMS/Marine_Monitoring_Program/CTD_profiles/2006/BUR4/AIMS_MMP-WQ_20061027T111208Z_WQN083_FV01_Profile-SBE19plus_C-20210831T061352Z.nc',
